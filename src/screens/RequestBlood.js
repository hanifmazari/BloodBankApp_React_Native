...
export default function RequestBlood () {
    ...
    const [data, setData ] = useState({
        ...
        hospitalValidation: true,
    })
    // database().ref('/').child('bloodRequest').push()
    ...
    const validation = () =>{
        if(data.name.trim === " " || data.name.length<3 ) {
            ...
            if (data.hospital.trim === " " || data.hospital.length < 11){
                setData({
                    ...data,
    ...
    return (
      ...
      <View style={styles.main}>
          ...
          <View style={styles.container}>
            <Text style={{ fontSize:18,color:"#1a1a1a",padding:5}}>Request for Blood</Text>
            ...
            <View style = {styles.titileContianer}>
                <Text style= {styles.titleText}>Hospital Name</Text>
                <TextInput placeholder="Hospital Name" autoFocus={true} 
                style={styles.TextInputo} onChange={(e)=>inputData(e, 'hospital') } />
                {!data.nameValidation && <Text style={{color:'red'}}>Enter a Valid Name with more than 3 characters</Text> } 
            ...
            <View style = {styles.titileContianer}>
                ...
                <Text style={styles.BeDonorTxt}>Request Blood</Text>
                </TouchableOpacity>
